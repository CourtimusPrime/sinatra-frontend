...
export const backgrounds = [
  ...
  { id: "bg-gradient", label: "Gradient", class: "bg-gradient-to-r from-pink-500 to-purple-500" },
  { id: "bg-vapor", label: "Vaporwave", class: "bg-purple-100 dark:bg-purple-900" },
  { id: "bg-neon", label: "Neon", class: "bg-pink-900" },
  { id: "bg-solar", label: "Solarized", class: "bg-yellow-100 dark:bg-yellow-200" },
];
...
export const textColors = [
  { id: "text-default", label: "Default", class: "text-gray-900 dark:text-white" },
